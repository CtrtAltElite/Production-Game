...
void LevelThreeScene::Start()
{
	...
	SetBackground(new Background("../Assets/textures/Levels/3rd_level.png", "thirdLevel"));
...
void LevelThreeScene::SaveObstaclesToFile()
{
}

void LevelThreeScene::LoadObstaclesToFile()
{
}
