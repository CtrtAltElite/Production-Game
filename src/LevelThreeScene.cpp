...
{
	SoundManager::Instance().Load("../Assets/audio/l3.mp3", "l3", SoundType::SOUND_MUSIC);
	SoundManager::Instance().PlayMusic("l3", 0);
	constexpr SDL_Color blue = { 0, 0, 255, 255 };
	constexpr SDL_Color Black = { 255, 255, 255, 255 };
	m_pStartLabel = new Label("Level 3", "Dock51", 80, blue, glm::vec2(1280/2,100));
	m_pStartLabel->SetParent(this);
	AddChild(m_pStartLabel);

	m_pInstructionsLabel = new Label("GET OUT OF HERE NOW!", "Consolas", 40, blue, glm::vec2(1280/2, 720/2-150));
	...
	m_pStartButton->AddEventListener(Event::CLICK, [&]()-> void
	{
		...
		SoundManager::Instance().stop_music("l3", 0);
	});
