...
void PrologueScene::Clean()
{
	RemoveAllChildren();
}

void PrologueScene::HandleEvents()
{
...
void PrologueScene::Start()
{
	...
	SoundManager::Instance().Load("../Assets/audio/Recruited.mp3", "Recruited", SoundType::SOUND_MUSIC);
	SoundManager::Instance().PlayMusic("Recruited", 0);

	constexpr SDL_Color blue = { 0, 0, 255, 255 };
	constexpr SDL_Color Black = { 255, 255, 255, 255 };
	m_pStartLabel = new Label("PROLOGUE", "Dock51", 80, blue, glm::vec2(1280/2,100));
	m_pStartLabel->SetParent(this);
	AddChild(m_pStartLabel);

	m_pInstructionsLabel = new Label("Click to Shoot. Press SPACE to move. GET IT THROUGH YOUR HEAD", "Consolas", 30, blue, glm::vec2(1280/2, 720/2-150));
	...
	//	SoundManager::Instance().stop_music("Recruited", 0);
	//});
	//
