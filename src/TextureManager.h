...
public:
	...
	void DrawScale(const std::string& id, int x, int y, float scale = 1, double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
	...
	void Draw(const std::string& id, glm::vec2 position, double angle = 0, int alpha = 255, Uint8 red = 255, Uint8 green = 255, Uint8 blue = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
