...
public:
	...
	void Draw(const std::string& id, b2Vec2 position, double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
	...
	void DrawText(const std::string& id, b2Vec2 position, double angle, int alpha, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
	// animation functions
	...
	void PlayAnimation(const std::string& sprite_sheet_name, Animation& animation, b2Vec2 position, float speed_factor, double angle, int alpha, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
	...
	b2Vec2 GetTextureSize(const std::string& id);
